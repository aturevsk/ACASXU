###########################################################################
## Makefile generated for component 'ACASXU_Simulink'. 
## 
## Makefile     : ACASXU_Simulink.mk
## Generated on : Mon Mar 30 22:41:03 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ACASXU_Simulink
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ACASXU_Simulink
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ACASXU_Simulink_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=ACASXU_Simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ACASXU_Simulink_ert_rtw/ACASXU_Simulink.c $(START_DIR)/ACASXU_Simulink_ert_rtw/ACASXU_Simulink_data.c

MAIN_SRC = $(START_DIR)/ACASXU_Simulink_ert_rtw/ert_main.c
...
OBJS = ACASXU_Simulink.o ACASXU_Simulink_data.o
...
%.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ACASXU_Simulink.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/ACASXU_Simulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ACASXU_Simulink_data.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/ACASXU_Simulink_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ACASXU_Simulink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
